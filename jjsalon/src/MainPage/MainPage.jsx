...
<div className={styles.MainWrapper}>
    <Box className={styles.reservationWrapper}>
        ...
        <span>Salon JJ w Rynarzewie to miejsce w którym możesz skorzystać z kompleksowych usług kosmetycznych oraz zasięgnąć fachowych porad z zakresu pielęgnacji.</span>
